                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="special_price_type" class="form-control">
                                                                <optgroup label="من فضلك أختر النوع "> 
                                                                    <option value="percent" @if($product->special_price_type === 'percent') selected @endif>نسبه</option>
                                                                    <option value="fixed" @if($product->special_price_type === 'fixed') selected @endif>ثابت</option>
                                                                </optgroup>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="price"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{ $product->special_price_end ?? old('special_price_end')}}"
