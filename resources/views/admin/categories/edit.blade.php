                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{$type === TYPE ? 'تعديل قسم رئيسي' : 'تعديل قسم فرعي'}} </h4>
                                                                    ...
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $main_category)
                                                                            ...
                                                                            value="{{$main_category->id }}" 
                                                                                @if((int)$main_category->id === (int)$category->parent_id)
                                                                                    {{'selected'}}
                                                                                @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if((int)$category->is_active === 1)checked @endif/>
